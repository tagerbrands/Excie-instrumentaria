...
# Replace the text-color logic
old_header_start = """            <h4 className={`font-black text-xl uppercase tracking-wider ${colorClass.split(' ')[0]}`}>"""
...
text = text.replace(old_header_start, new_header_start)

# Replace the tab colors logic
